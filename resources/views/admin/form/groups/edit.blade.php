        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    <form class="form-horizontal" role="form" method="POST" action="{{ route('groups.update') }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        ...
                        @if($group->logo)
                            <div class="form-group">
                                ...
                                <div class="col-md-6 text-center">
                                    <img class="logo-img" src="{{ asset($group->logo) }}" alt="{{ $group->name }}"/>
                                </div>
                            </div>
                        @endif
